		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice List",
									"targetURL": "#comdprbinvoicelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdprbinvoicelist-display": {
								"semanticObject": "comdprbinvoicelist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dprb.invoicelist",
									"url": sap.ui.require.toUrl("com/dprb/invoicelist")
								}
							}
						}
					}
